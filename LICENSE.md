...
http://www.binpress.com/license/view/l/d744ac169cf2306c6bf3aa2716a5ac1b
...
No commercial use is allowed useless prior written consent is given by Joe Rowley.
...
Angular.js and Twitter Bootstrap at both under MIT license.
 For more information on the license summary topics
 Terms and conditions

Preamble: This Agreement, signed on Apr 26, 2014 [hereinafter: Effective Date] governs the relationship between Joseph Rowley, a private person, (hereinafter: Licensee) and Joseph Rowley, a private person whose principal place of business is WI, United States (Hereinafter: Licensor). This Agreement sets the terms, rights, restrictions and obligations on using [GadCalc] (hereinafter: The Software) created and owned by Licensor, as detailed herein
...
Commercial use allowed with restrictions: No commercial use is allowed useless prior written consent is given by Joe Rowley.
